...
# Use this bot
If you want to use this bot, add it by following the link TODO. The bot does not require administrator privileges, but has to be able to create / delete channels, roles and messages to handle the round correctly.
